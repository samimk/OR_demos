"""
Tabu pretraživanje (Tabu Search) - Demo aplikacija
Demonstrira lokalno pretraživanje i tabu pretraživanje sa Tkinter GUI
"""
...
class TabuSearchDemo:
    def __init__(self, root):
        self.root = root
        self.root.title("Tabu pretraživanje - Demo aplikacija")
    ...
    def setup_gui(self):
        ...
        # Tab 3: Prikaz/Vizualizacija tab
        ...
        view_buttons_frame = ttk.Frame(view_tab_frame)
    ...
    def on_about(self):
        ...
        messagebox.showinfo("O aplikaciji",
                          "Tabu pretraživanje - Demo aplikacija\n\n" +
    ...
    def on_help(self):
        """Prikaži Help dialog"""
        help_text = """UPUTE ZA KORIŠTENJE - Tabu pretraživanje
...
Omogućava izbjegavanje lokalnih minimuma i dalje istraživanje
prostora rješenja.
...
if __name__ == "__main__":
    print("="*80)
    print("Tabu pretraživanje (Tabu Search) - Demo Aplikacija")
    print("="*80)
    print("\nFunkcionalnosti:")
